<header style="margin-bottom: 30px !important">
	...
	<span align="center" class="p" style="display:inline-block;margin-left:35%;padding-bottom:-15px !important;text-align: center">{{ $university->university }}</span>
	<span align="center" class="p" style="display:inline-block;margin-left:42%;padding-bottom:-15px ">VICERRECTORADO ACADÉMICO</span>
	<span align="center" class="p" style="display:inline-block;margin-left:43%;padding-bottom:-17px !important">{{ $university->address->addres }}</span>
